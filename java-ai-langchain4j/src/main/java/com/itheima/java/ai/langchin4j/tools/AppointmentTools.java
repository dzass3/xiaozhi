package com.itheima.java.ai.langchin4j.tools;
 ...
 public class AppointmentTools {
    ...
    @Tool(name="book_appointment", value = "根据参数，先执行工具方法queryDepartment查询是否可预约，并直接给用户回答是否可预约，并让用户确认所有预约信息，用户确认后再进行预约。如果用户没有提供具体的医生姓名，请从\n" +"向量存储中找到一位医生。")
    ...
    @Tool(name = "query_appointment_availability", value="根据科室名称，日期，时间和医生查询是否有号源，并返回给用户")
